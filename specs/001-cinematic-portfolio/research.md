...
- _Jest + React Testing Library_: Good for logic, but poor for "scroll to X" or "tilt 3D card" verification.
- _Cypress_: Slower execution and more complex setup for this specific stack compared to Playwright.
